...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--title", type=str, default="Reminder")
...
def notify(title: str, message: list):
    ...
    subprocess.run([f'XDG_RUNTIME_DIR=/run/user/$(id -u) notify-send {title.capitalize()} {" ".join(message).capitalize()}'], shell=True)
    return
